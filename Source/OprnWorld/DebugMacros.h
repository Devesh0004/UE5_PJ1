...
#define DRAW_SPHERECOLOR(Location)DrawDebugSphere(GetWorld(), Location, 8.f, 12, FColor::Cyan, false,5.f);
...
#define DRAW_CYLINDER(StartLocation, EndLocation) if (GetWorld()) DrawDebugCylinder(GetWorld(), StartLocation, EndLocation, 20.f, 24, FColor::Red, true);